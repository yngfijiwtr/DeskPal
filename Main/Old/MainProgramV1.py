...
def get_sp500_price():
  ...
  sp500_price = sp500_data.history(period='1d')['Close'].iloc[-1]
  return sp500_price
def get_dow_jones_price():
  ...
  dow_jones_price = dow_jones_data.history(period='1d')['Close'].iloc[-1]
...
def get_nasdaq_price():
  ...
  nasdaq_price = nasdaq_data.history(period='1d')['Close'].iloc[-1]
  return nasdaq_price
